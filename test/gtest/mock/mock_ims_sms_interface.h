 ...
 */
#ifndef __MOCK_IMS_SMS_INTERFACE_H__
#define __MOCK_IMS_SMS_INTERFACE_H__
...
class MockImsSmsProxy : public ImsSmsProxy {
public:
    explicit MockImsSmsProxy(const sptr<IRemoteObject> &impl) : ImsSmsProxy(impl) {}
    sptr<IRemoteObject> AsObject() override
    {
        return retRemoteObject;
    }
