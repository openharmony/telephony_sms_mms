...
enum SmsCodingNationalType {
    SMS_CODING_NATIONAL_TYPE_DEFAULT = 0,
    SMS_CODING_NATIONAL_TYPE_TURKISH,
    SMS_CODING_NATIONAL_TYPE_SPANISH,
    SMS_CODING_NATIONAL_TYPE_PORTUGUESE,
};
