...
std::vector<int32_t> ShortMessageManager::CalculateLength(const std::u16string &message, bool force7BitCode)
{
    return DelayedSingleton<SmsServiceProxyHolder>::GetInstance()->CalculateLength(message, force7BitCode);
}
} // namespace Telephony
} // namespace OHOS