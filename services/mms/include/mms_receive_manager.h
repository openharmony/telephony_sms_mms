...
namespace OHOS {
namespace Telephony {
class MmsReceiveManager : public AppExecFwk::EventHandler {
public:
    explicit MmsReceiveManager(const std::shared_ptr<AppExecFwk::EventRunner> &runner, int32_t slotId);
